...
export default function CategoryContainer({ icon, label }: CategoryContainerProps) {
  return (
    <Link href={`/product/category/${label.toLocaleLowerCase()}`} className="no-underline w-[15%]">
